...
const shopLink = 'https://esimrus.ticaretai.tr/';

app.innerHTML = `
  <div style="background: var(--gradient-primary); color: white; text-align: center; padding: 10px; font-size: 0.95rem; font-weight: 600;">
    Наш официальный магазин: <a href="${shopLink}" style="color: white; text-decoration: underline;">esimrus.ticaretai.tr</a>
  </div>
  <header class="header container" style="display: flex; justify-content: space-between; align-items: center; width: 100%;">
    <div style="display: flex; align-items: center; gap: 12px;">
      <img src="https://static.tildacdn.pro/tild3061-6465-4639-b733-316463616337/homelogo.svg" alt="eMEDEO" style="height: 48px; object-fit: contain;">
    </div>
    <div class="desktop-only">
      <a href="${shopLink}" class="btn-header" style="display: inline-flex; align-items: center; height: 42px; padding: 0 20px;">
        <svg style="width: 18px; height: 18px; margin-right: 8px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
        Купить eSIM
      </a>
    </div>
  </header>
    ...
    <section class="hero container">
      <div class="hero-grid reveal">
        ...
        <div style="display: flex; gap: 16px; align-items: center; justify-content: center; flex-wrap: wrap; margin-bottom: 32px;">
          <a href="${shopLink}" class="btn-primary" style="min-width: 280px;">
            <svg style="width: 24px; height: 24px; margin-right: 12px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
            Купить eSIM онлайн
          </a>
          <div class="desktop-only glass" style="padding: 10px; border-radius: 16px; background: white;">
            <img src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${encodeURIComponent(shopLink)}" alt="QR Code" style="width: 60px; height: 60px; display: block;">
          </div>
        </div>
      ...
      <div class="hero-grid reveal">
        ...
        <div style="display: flex; flex-direction: column; gap: 20px; align-items: center;">
          <div style="display: flex; gap: 12px; align-items: center; padding: 12px 24px; background: var(--panel-bg); border-radius: 12px; width: 100%; max-width: 400px;">
            ...
            <span style="font-weight: 500;">Активация за 1 минуту после покупки</span>
          </div>
          <div style="display: flex; gap: 12px; align-items: center; padding: 12px 24px; background: var(--panel-bg); border-radius: 12px; width: 100%; max-width: 400px;">
    ...
    <section class="container" id="tariffs">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 24px;">
        ...
        <div class="glass reveal" style="padding: 32px; display: flex; flex-direction: column;">
          ...
          <a href="${shopLink}" class="btn-primary" style="width: 100%; padding: 14px 24px; font-size: 1rem;">Купить</a>
        </div>
      ...
      <div class="container">
        ...
        <div class="audience-grid">
          <div class="feature-item reveal" style="text-align: center;">
            ...
            <h4>Выбери страну</h4>
            <p>В магазине доступно более 190 стран и гибкие пакеты трафика.</p>
          </div>
          <div class="feature-item reveal" style="text-align: center;">
          ...
          <div class="feature-item reveal" style="text-align: center;">
            ...
            <h4>Активируй QR</h4>
            <p>Сканируй полученный код и пользуйся интернетом сразу.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section style="text-align: center; padding: 100px 0;">
      <div class="container reveal">
        ...
        <div style="margin-top: 40px; display: flex; justify-content: center; flex-wrap: wrap; gap: 20px;">
          <a href="${shopLink}" class="btn-primary" style="padding: 20px 60px; font-size: 1.2rem; width: 100%; max-width: 400px;">
            <svg style="width: 24px; height: 24px; margin-right: 12px;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="21" r="1"></circle><circle cx="20" cy="21" r="1"></circle><path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"></path></svg>
            Перейти в магазин
          </a>
        </div>
      ...
      <div class="footer-grid">
        ...
        <div>
          ...
          <ul class="footer-links">
            ...
            <li><a href="${shopLink}">Тарифы</a></li>
            <li><a href="${shopLink}">Поддержка</a></li>
          </ul>
        </div>
        <div>
          <h4 style="margin-bottom: 24px;">Магазин</h4>
          <ul class="footer-links">
            <li><a href="${shopLink}">esimrus.ticaretai.tr</a></li>
...
// Click tracking for shop links
document.querySelectorAll('a[href*="ticaretai.tr"]').forEach((link) => {
  link.addEventListener('click', () => {
    // Track conversion event
    track('shop_conversion', { 
